...
The distribution of $log(\widehat{\beta_0}*\widehat{\beta_1})$ is normal with a peak of 2.1, which means the majority of the bootstrapped samples have an $log(\widehat{\beta_0}*\widehat{\beta_1})$ value around 2.1
